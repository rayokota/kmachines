...
package io.kmachine.rest.server.actuator;
...
import io.kmachine.rest.server.KMachineProperties;
import reactor.core.publisher.Mono;

@Component
@EnableConfigurationProperties(KMachineProperties.class)
public class KafkaHealthIndicator implements ReactiveHealthIndicator {

    private final KMachineProperties props;

    public KafkaHealthIndicator(KMachineProperties props) {
        this.props = props;
    }
